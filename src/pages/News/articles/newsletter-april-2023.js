...
const newsletterApril2023 = ({ imagePrefix }) => {
  return (
    <div className="content-container article">
      <Helmet>
        <title>The Good News - April 2023 | Elevation of the Holy Cross Sacramento</title>
      </Helmet>
            ...
            <div className="section">
              ...
              <div className="article-body" style={{ clear: 'all' }}>
                <div style={{ float: 'left', maxWidth: '50%', marginRight: '2rem' }}>
                  <img src={ require('../../../assets/images/news/newsletter-april-2023-1.jpg') } alt="Rector's Reflection - The Pilgrimage to Pascha" />
                </div>
                ...
                <p>
                  In one of the hymns for Holy Monday, we sing: <em>As the Lord went to His voluntary Passion, He said to His apostles on the way: ‘Behold, we go up to Jerusalem, and the Son of Man shall be betrayed as it is written of Him.' Come, then, and let us also journey with Him, purified in mind; let us be crucified with Him and die for His sake to the pleasures of this life, that we may also live with Him and hear Him say: ‘No longer do I ascend to the earthly Jerusalem to suffer, but I ascend to My Father and your Father…and I shall raise you up to the Jerusalem on High in the Kingdom of Heaven.”</em>
                </p>
                <p>
                ...
                <p>
                  Just before our Lord went to raise Lazarus from the dead, some of his disciples were afraid to return to Jerusalem because they knew the Jewish leaders were already plotting to kill Jesus. But Thomas spoke out and boldly declared: <em>Let us also go, that we may die with Him!</em> Let us take courage like Thomas and embark upon this Holy Pilgrimage to Golgotha, that we too may sing: <em>We venerate thy Passion, O Christ; We venerate thy Passion, O Christ; We venerate thy Passion, O Christ. Show us also Thy glorious Resurrection!</em> (15th Antiphon of Great and Holy Friday)
                </p>
              </div>
            </div>
            ...
            <div className="section" style={{ marginBottom: '32px', paddingBottom: '16px', borderBottom: '1px solid rgba( 0, 0, 0, .2 )' }}>
              ...
              <div className="article-body" style={{ clear: 'all' }}>
                <div style={{ float: 'right', maxWidth: '50%', marginLeft: '2rem' }}>
                  <img src={ require('../../../assets/images/news/newsletter-april-2023-2.jpg') } alt="2023 Lenten Retreat with Mother Melania" />
                </div>
...
Great Lent, especially the fasting rules. To combat our spiritual pride, we must constantly bear in mind that we are sinners, and we must be constantly repenting. Finally, so as to illustrate these notions, Mother Melania read us a children’s story she had written titled <em>Pascha at the Duckpond</em>. The main character is Rigid Rooster, who is so obsessed with the rules of Great Lent that he nearly missed the point of Great Lent – Pascha itself – that Christ has indeed trampled down death by death and has bestowed upon us eternal life.
            ...
            <div className="section" style={{ marginBottom: '32px', paddingBottom: '16px', borderBottom: '1px solid rgba( 0, 0, 0, .2 )' }}>
              ...
              <div className="article-body" style={{ clear: 'all' }}>
                <img src={ require('../../../assets/images/news/newsletter-april-2023-3.jpg') } alt="Snow day 1" />

                <div style={{ float: 'right', maxWidth: '50%', marginTop: '1rem', marginLeft: '2rem' }}>
                  <img src={ require('../../../assets/images/news/newsletter-april-2023-4.jpg') } alt="Snow day 2" style={{ marginTop: '1rem', marginBottom: '1rem' }} />
                </div>
            ...
            <div className="section" style={{ marginBottom: '32px', paddingBottom: '16px', borderBottom: '1px solid rgba( 0, 0, 0, .2 )' }}>
              ...
              <div className="article-body" style={{ clear: 'all' }}>
                <img src={ require('../../../assets/images/news/newsletter-april-2023-6.jpg') } alt="The Great Blessing of the Water 1" />

                <div style={{ float: 'right', maxWidth: '50%', marginTop: '1rem', marginLeft: '2rem' }}>
                  <img src={ require('../../../assets/images/news/newsletter-april-2023-7.jpg') } alt="The Great Blessing of the Water 2" style={{ marginTop: '1rem', marginBottom: '1rem' }} />
                </div>
              ...
              <div className="article-body" style={{ clear: 'all' }}>
                ...
                <p>
                  Sat. 4/8 Divine Liturgy (Lazarus Saturday), 9:00 AM (work party after)
	                <br/>
                  <span style={{ opacity: 0 }}>Sat. 4/8 </span> Vigil of Palm Sunday, 5:30 PM
                </p>
                <p>
                  Sun. 4/9 Divine Liturgy (Palm Sunday), 9:00 AM
	                <br/>
                  <span style={{ opacity: 0 }}>Sun. 4/9 </span> Bridegroom Matins of Great & Holy Monday, 6:00 PM
                </p>
                <p>
                ...
                <p>
                  Thu. 4/13 Vesperal Divine Liturgy of Holy Thursday, 9:00 AM
	                <br/>
                  <span style={{ opacity: 0 }}>Thu. 4/13 </span> Matins of Holy Friday - 12 Passion Gospels, 6:00 PM
                </p>
                <p>
                  Fri. 4/14 Royal Hours, 9:00 AM
	                <br/>
                  <span style={{ opacity: 0 }}>Fri. 4/14 </span> Vespers of Holy Friday (Burial Service), 3:00 PM
	                <br/>
                  <span style={{ opacity: 0 }}>Fri. 4/14 </span> Matins of Holy Saturday, 6:00 PM
                </p>
                <p>
                  Sat. 4/15 Vesperal Divine Liturgy of Holy Saturday, 9:00 AM
	                <br/>
                  <span style={{ opacity: 0 }}>Sat. 4/15 </span> PASCHAL VIGIL (Nocturns, Matins & Divine Liturgy), 11:00 PM
                </p>
                <p>
...
export default newsletterApril2023;
